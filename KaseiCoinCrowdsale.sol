...
contract KaseiCoinCrowdsale is Crowdsale, MintedCrowdsale, CappedCrowdsale, TimedCrowdsale, RefundablePostDeliveryCrowdsale {    
    ...
    constructor(
        ...
        address payable wallet, //sale beneficiary where to deposit the funds that the token raises
        KaseiCoin token, // the KaseiCoin itself that the KaseiCoinCrowdsale will work with
        uint goal, //amount of ether that is the goal to raise during the crowdsale
...
contract KaseiCoinCrowdsaleDeployer {
    ...
    constructor(
       ...
       uint goal
        ...
        // Create a new instance of the `KaseiCoinCrowdsale` contract. Set rate equal to 1 to maintain parity with ether
